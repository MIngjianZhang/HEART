  ...
  public class TcpClientReceiver {
       ...
       public static void main(String[] args) {
         ...
         String imagetoopen = "C:\\Users\\ROC-HCI-1\\Desktop\\New Folder\\SVM\\SVM.py";
         ...
         String emmm = "C:\\Users\\ROC-HCI-1\\Downloads\\cyberglove\\VirtualHand SDK\\VirtualHand SDK\\demos\\bin\\winnt_x64\\Release\\notepad.exe";
        ...
        while(true)
        {
         ...
         if(valid){
            ...
            if (send){
              ...
              if (currentHandPosition < -40){
                System.out.println("  X  O  O  O  O  ");
              }else if (currentHandPosition >= -40 && currentHandPosition < -20){
                System.out.println("  O  X  O  O  O  ");
              }else if (currentHandPosition >= -20 && currentHandPosition < 10){
                System.out.println("  O  O  X  O  O  ");
              } else if (currentHandPosition >= 10 && currentHandPosition < 30){
                System.out.println("  O  O  O  X  O  ");
              } else if (currentHandPosition >= 30){
                System.out.println("  O  O  O  O  X  ");
              }
              /*try{
    ...
    public static float HandPosition (float a, float b, float original){
      ...
      float tmpClient = 300000 *b - 150000* a;
